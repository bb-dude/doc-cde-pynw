...
#      fm the git, go git yo-sef, yeah was!! ))
#      fm the git, go git yo-sef, yeah was!!  ))
...
#    scanip.scanip.start_scan()
    ...
    print (IP1,'    local ip here bro!!')
    IP2 = socket.gethostbyname('z501') # IP adress of remote computer
    print (IP2,'    what u was??!!')
